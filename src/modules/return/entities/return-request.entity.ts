...
import { ReturnStatus, ReturnReason, RefundMethod } from '../enums/return.enum.js';
...
export class ReturnRequest {
  ...
  @Column({ type: 'enum', enum: ReturnStatus, default: ReturnStatus.PENDING_REVIEW })
  status!: ReturnStatus;
  ...
  @Column({ name: 'refund_amount', type: 'decimal', precision: 15, scale: 0, nullable: true })
  ...
  @OneToMany(() => RefundTransaction, (tx) => tx.returnRequest, { cascade: true })
